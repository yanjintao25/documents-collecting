...
class Tag(BaseModel):
    ...
    __table_args__ = (
        ...
        Index("idx_tags_status", "status", comment="状态索引"),
        Index("idx_tags_delete_flag", "delete_flag", comment="删除标志索引"),
        Index("idx_tags_color", "color", comment="颜色索引"),
        Index("idx_tags_create_time", "create_time", comment="创建时间索引"),
        Index("idx_tags_update_time", "update_time", comment="更新时间索引"),
    )
